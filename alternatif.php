    ...
    <div class="admin-main">
      <nav class="navbar admin-navbar navbar-expand bg-white">
        <div class="container-fluid px-3 px-lg-4">
          ...
          <form class="d-none d-md-flex ms-3 flex-grow-1" role="search">
            <input class="form-control search-input" type="search" placeholder="Search parameters, alternatives..." aria-label="Search">
          </form>
      ...
      <main class="dashboard-content">
        <div class="container-fluid px-3 px-lg-4 py-4">
          ...
          <div class="page-heading mb-4">
            <div class="page-heading-copy">
              ...
              <div>
                ...
                <p class="text-muted mb-0">Kelola objek smartphone yang akan dinilai dalam Sistem Pendukung Keputusan.</p>
              </div>
            </div>
          </div>

          <?php if(!empty($success)): ?>
            <div class="alert alert-success alert-dismissible fade show border-0 shadow-sm mb-3 py-2 px-3 small" role="alert">
          ...
          <?php if(!empty($error)): ?>
            <div class="alert alert-danger alert-dismissible fade show border-0 shadow-sm mb-3 py-2 px-3 small" role="alert">
          ...
          <div class="row g-4">
            <div class="col-12 col-lg-4">
              <div class="card border-0 shadow-sm p-4 h-100 bg-white rounded-3">
                <h3 class="h5 mb-2 fw-bold text-dark"><i class="bi bi-plus-circle me-2 text-primary"></i>Tambah Objek</h3>
                <p class="text-muted small mb-4">Masukkan nama smartphone seri terbaru untuk menambah opsi alternatif matriks.</p>
                
                <form method="POST" action="alternatif.php">
                  <div class="mb-4">
                    <label for="nama_smartphone" class="form-label fw-semibold text-secondary small">Nama Alternatif / Smartphone</label>
                    <div class="input-group">
                      <span class="input-group-text bg-light border-end-0 text-muted"><i class="bi bi-phone-vibrate"></i></span>
                      <input type="text" id="nama_smartphone" name="nama_smartphone" class="form-control bg-light border-start-0 ps-1" placeholder="Contoh: iPhone 15 Pro Max" required>
                    </div>
                  </div>
                  <button type="submit" name="add_alternatif" class="btn btn-primary w-100 py-2 fw-semibold shadow-sm"><i class="bi bi-plus-lg me-2"></i>Simpan Alternatif</button>
                </form>
              </div>
            </div>
            ...
            <div class="col-12 col-lg-8">
              <section class="panel shadow-sm border-0 bg-white rounded-3">
                <div class="panel-header d-flex justify-content-between align-items-center p-3 border-bottom bg-light">
                  ...
                  <input class="form-control form-control-sm w-auto shadow-sm" type="search" placeholder="Cari smartphone..." id="searchAlt" aria-label="Search">
                </div>
                          ...
                          <tr>
                            ...
                            <td class="text-end pe-4">
                              <div class="d-inline-flex gap-1">
                                <button type="button" class="btn btn-outline-warning btn-sm border-0 shadow-none px-2 py-1" title="Edit Alternatif" onclick="alert('Fitur edit untuk ID <?php echo $ra['id_alternatif']; ?> dapat disesuaikan dengan kebutuhan.');">
                                  <i class="bi bi-pencil-square"></i>
                                </button>
                                <a href="alternatif.php?del_alternatif=<?php echo $ra['id_alternatif']; ?>" class="btn btn-outline-danger btn-sm border-0 shadow-none px-2 py-1" title="Hapus Objek" onclick="return confirm('Apakah Anda yakin ingin menghapus alternatif <?php echo $ra['nama_alternatif']; ?>?');">
      ...
      <footer class="admin-footer">
        <div class="container-fluid px-3 px-lg-4">
          <span>Copyright 2026 Smartphone. <br> Developed by <a target="_blank" class="fw-bold text-success" href="https://github.com/ginaa07">Kelompok 10</a> • Distributed by <a target="_blank" class="fw-bold text-success" href="https://themewagon.com">ThemeWagon</a> </span>
          <span>Sistem Pendukung Keputusan | TOPSIS | TI SE 2</span>
        </div>
      </footer>
    </div>
  </div>
